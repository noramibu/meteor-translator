package me.noramibu.translator.modules;

import me.noramibu.translator.MeteorTranslator;
...
public class ModuleExample extends Module {
    ...
    public ModuleExample() {
        super(MeteorTranslator.CATEGORY, "world-origin", "An example module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link MeteorTranslator#getPackage()} to be setup correctly, otherwise the game will crash whenever the module is enabled.
     */
    @EventHandler
